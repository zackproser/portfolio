...
interface CategoryBasedComparisonSearchProps {
  tools: Tool[]
}

export function CategoryBasedComparisonSearch({ tools }: CategoryBasedComparisonSearchProps) {
      ...
      <Card className="bg-gradient-to-br from-white to-blue-50/30 dark:from-gray-800 dark:to-blue-900/10 border-2 border-blue-200 dark:border-blue-800 shadow-xl">
        <CardHeader className="bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-t-lg">
          ...
          <CardDescription className="text-blue-100">
            Browse tools by category to find meaningful comparisons
          </CardDescription>
        </CardHeader>
        <CardContent>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <div className="max-h-64 overflow-y-auto space-y-2 border rounded-lg p-2">
                {filteredTools.map(tool => {
                  const canSelect = !selectedTool2 || canCompareTools(tool, selectedTool2)
                  return (
                    <div
                      key={tool.id}
            ...
            <div>
              ...
              <div className="max-h-64 overflow-y-auto space-y-2 border rounded-lg p-2">
                {filteredTools.map(tool => {
                  const canSelect = !selectedTool1 || canCompareTools(selectedTool1, tool)
                  return (
                    <div
                      key={tool.id}
        ...
        <CardContent className="p-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <div className="group p-4 rounded-xl bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/30 dark:to-green-800/30 border border-green-200 dark:border-green-700 hover:shadow-lg transition-all duration-200 transform hover:scale-105">
              <div className="text-center">
                <div className="text-3xl font-bold text-green-600 dark:text-green-400 mb-1">{comparisonCategories.length}</div>
