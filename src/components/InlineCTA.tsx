...
export function InlineCTA({ heading }: InlineCTAProps) {
  ...
  return (
    <aside className="my-6 flex items-center gap-3 rounded-lg border border-orange-400/40 bg-orange-50/70 px-4 py-2 text-sm dark:border-orange-400/30 dark:bg-orange-950/25">
