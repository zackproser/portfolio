...
const SkillCard = ({ skill, index }: { skill: SkillData, index: number }) => {
  ...
  return (
    <div className="group relative bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 hover:bg-white/10 transition-all duration-300">
