        ...
        <div className="xl:relative">
          <div className="mx-auto max-w-2xl">
            <Button
              ...
              color="slate"
            >
              <ArrowLeftIcon className="h-4 w-4 stroke-amber-500 transition group-hover:stroke-amber-700 dark:stroke-amber-400 dark:group-hover:stroke-amber-300" />
            </Button>
            <article>
              <header className="flex flex-col">
                <h1 className="mt-6 text-4xl font-bold tracking-tight text-burnt-400 dark:text-amber-400 sm:text-5xl">
                  {metadata.title}
                </h1>
                <time
