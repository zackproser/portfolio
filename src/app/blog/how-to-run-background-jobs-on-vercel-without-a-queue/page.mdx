...
I've made a [video](/videos/panthalia-intro) before about how my open-source app, [Panthalia](https://github.com/zackproser/panthalia), empowers me to author media rich blog posts in a streamlined fashion even while traveling and away from my keyboard, by 
converting the words I speak and type into my phone into fully fledged blog posts on my site [zackproser.com](https://zackproser.com).

Zackproser.com or, my portfolio site, as I refer to it is [also a Next.js project that is open-source and stored on GitHub](https://github.com/zackproser/portfolio).

## The problem(s)

Panthalia is designed to be the ideal mobile-first interface for publishing blog posts on my personal website.
