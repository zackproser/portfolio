...
import developerDelight from '@/images/developer-delight.png'
import developerDelightTwo from '@/images/developer-delight2.png'
import sadDeveloper from '@/images/sad-developer.png'
import sadDeveloperTwo from '@/images/sad-developer2.png'
import gitXargsChecks from '@/images/git-xargs-checks.png'
import pageripperChecks from '@/images/pageripper-checks.png'
import cicdAutomations from '@/images/cicd-automations.png'

import pulumiPreview from '@/images/pulumi-pr-preview.png'
...
export const meta = {
    ...
    date: "2024-01-01",
    title: "A Blueprint for Modern API Development: Lessons from Building Pageripper", 
...
In this post, I'll detail the Continuous Integration and Continuous Delivery (CI/CD) automations I've configured via GitHub Actions for my Pageripper project, explain how they work and why they make working on this project delightful.

<Image src={pageripperChecks} alt="CI/CD automations for Pageripper" />

## Why care about developer experience? 

As a busy open-source developer, I find working on well-automated repositories delightful. I've noticed that tasks on repositories that are 
correctly instrumented and automated feel significantly less onerous, because I can focus on logic and UX, and not need to worry about wrestling with configuration or installing some funky toolchain. 

<Image src={developerDelightTwo} alt="Developer delight and project velocity are related" />

When I was working on [git-xargs](https://github.com/gruntwork-io/git-xargs), a popular open-source project that we produced at Gruntwork.io, which was also set up with a great CI/CD pipeline, I found community pull requests, new features and bug fixes 
to be easier to work on, because I just opened my pull request, iterated on any test failures, then merged with confidence to get a new release. 
...
Continuous Integration is about constantly merging into your project verified and tested units of incremental value. You add a new feature, test it locally and then push it up on a branch and open a pull request. 
...
Developers get feedback on their changes in a minute or less, so they know that 
...
For consistency and the many downstream benefits (documentation and SDK generation, for example), I maintain an OpenAPI spec for Pageripper. On every pull request, this spec is validated to ensure no changes or typos broke anything. This spec is used 
...
* Worry about scheduling deployments for certain days of the week - they can deploy multiple times a day 
