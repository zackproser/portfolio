...
export const metadata = createMetadata({
  ...
  date: '2024-02-13',
  title: 'Build Production-Ready RAG Applications',
  description: 'Step by step tutorial on building production-ready Retrieval Augmented Generation (RAG) pipelines',
  image: ragPipelineElements,
  type: 'blog',
  slug: 'rag-pipeline-tutorial',
  landing: {
    subtitle: 'Master the most in-demand Gen AI skill with a complete, production-ready RAG pipeline tutorial.',
    features: [
      {
        title: 'Modern RAG Pipeline using the latest tools',
        description: 'Learn to build a production-ready RAG pipeline using the Vercel AI SDK'
      },
      {
        title: 'Vector Search Mastery',
        description: 'Master embeddings, vector databases, and semantic search'
      },
      {
        title: 'Streaming Chat Interface',
        description: 'Build real-time chat UIs with citations and context'
      },
      {
        title: 'Production Best Practices',
        description: 'Learn deployment, scaling, and maintenance best practices'
      }
    ],
    testimonials: [
      {
        content: 'Thanks for publishing the tutorial, very helpful.',
        author: {
          name: 'Scott McCallum',
      ...
      {
        content: 'Finally, a RAG tutorial that goes beyond the basics. The production considerations were invaluable.',
        author: {
      ...
      {
        content: 'The complete package is worth it. The example code and deployment guides saved me weeks of work.',
        author: {
          name: 'Regina Wisoky',
          role: 'AI Engineer'
        }
  ...
  commerce: {
    ...
    previewLength: 150,
    previewElements: 49,
    paywallHeader: "Master RAG Pipeline Creation",
    paywallBody: "Get everything you need to build production-ready RAG applications: step-by-step tutorials, ready-to-use notebooks, and a complete example site. Perfect for developers who want to add the most in-demand Gen AI skill to their toolkit.",
    buttonText: "Get the complete package ($49)",
    miniPaywallTitle: "Master RAG pipeline creation",
    miniPaywallDescription: "Includes tutorials, notebooks, and a complete example site.",
    paywallImage: ragPipelineElements,
    paywallImageAlt: "The complete RAG development package: Tutorials, Notebooks, and Example Site"
  }
});

export default function Page(props) {
  return <ArticleLayout metadata={metadata} {...props} />;
}
...
export async function POST(req: Request) {
  ...
  const relatedPosts = await Promise.all(
    Array.from(blogUrls).map(async url => {
      ...
      return importContentMetadata(blogPath, 'blog')
    })
  )
