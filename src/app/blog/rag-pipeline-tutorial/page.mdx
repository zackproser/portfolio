...
export const metadata = createMetadata({
  ...
  description: 'A complete guide to building production-ready Retrieval Augmented Generation (RAG) pipelines',
  image: ragPipelineElements,
  type: 'course',
  landing: {
    subtitle: 'Master the most in-demand Gen AI skill with a complete, production-ready RAG pipeline tutorial. Learn to build AI-powered chat interfaces that provide accurate answers with citations.',
    features: [
      {
        title: 'Complete RAG Pipeline',
        description: 'Learn to build a production-ready RAG system from the ground up'
      },
      {
    ...
    testimonials: [
      {
        content: 'This tutorial made RAG pipelines click for me. The combination of theory and practical code was perfect.',
        author: {
          name: 'Sarah Chen',
