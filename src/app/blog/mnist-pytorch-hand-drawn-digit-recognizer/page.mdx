...
PyTorch MNIST is the repo for training the model. 
<Image src={pytorchMNISTLogo} alt={"The PyTorch MNIST logo"} />

The MNIST mind mapper app is built using PyTorch and Next.js. It uses the model that was trained via the pytorch-mnist repo.
<Image src={MNISTMindMapperLogo} alt={"The MNIST mind mapper logo"} />
