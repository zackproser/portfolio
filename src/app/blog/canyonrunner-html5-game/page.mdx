...
import canyonRunnerBlog from '@/images/canyonrunner-blog.webp'
import canyonRunnerSplash from '@/images/canyonrunner.webp'

import aerialCombat from '@/images/canyonrunner-screens/CanyonRunner-Aerial-Combat.webp'
import chapterScreen from '@/images/canyonrunner-screens/CanyonRunner-Chapter-Screen.webp'
import environmentalEffects from '@/images/canyonrunner-screens/CanyonRunner-Environmental-Effects.webp'
import mobileTouchpad from '@/images/canyonrunner-screens/CanyonRunner-Mobile-Touchpad.webp'
import canyonrunnerSuccess from '@/images/canyonrunner-screens/CanyonRunner-Success.webp'
import canyonrunnerTitleScreen from '@/images/canyonrunner-screens/CanyonRunner-Title-Screen.webp'
import multipleEndings from '@/images/canyonrunner-screens/CanyonRunner-Two-Different-Endings.webp'
...
<Image src={canyonRunnerSplash} alt="CanyonRunner - a complete HTML5 game" />
</Link>
...
To get a sense of CanyonRunner, or to play it through in its entirety (which will take you less than 10 minutes if you make zero mistakes), [click here to play!](https://canyonrunner.pages.dev)
...
<Image src={aerialCombat} alt="HTML5 dogfighting" />

**_Wind Your Way Through the Eerie Story_**

<Image src={chapterScreen} alt="CanyonRunner Chapter Screen" />

**_Intense Environmental Effects_**

<Image src={environmentalEffects} alt="CanyonRunner Environmental Effects" />

**_Auto-detects Mobile agents and renders a touchpad_**

<Image src={mobileTouchpad} alt="Game auto-detects mobile layouts and renders a touchpad when necessary" />

**_Catchy Music Keeps The Pace Throughout The Game_**

<Image src={canyonrunnerSuccess} alt="CanyonRunner Success" />

**_Save System Keeps Your Score & Progress_**

<Image src={canyonrunnerTitleScreen} alt="CanyonRunner Title Screen" />

**_Multiple Endings For Higher Replay Value_**

<Image src={multipleEndings} alt="CanyonRunner Two Different Endings" />
...
<iframe width="315" height="315" src="https://www.youtube.com/embed/DP49IKYYzZc" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>

## Table of Contents

What you'll find in this post:

*   <Link href={"#game-overview"} alt="Game overview">Game overview</Link>
*   <Link href={"#project-structure"}>Project structure</Link>
*   <Link href={"#node-js-server"}>Using Node.js as a simple server</Link>
*   <Link href={"#creating-a-preloader"}>Creating a preloader</Link>
*   <Link href={"#creating-a-splashscreen"}>Creating a splash screen</Link>
*   <Link href={"#linking-separate-levels"}>Linking separate levels</Link>
*   <Link href={"#creating-a-user-save-system"}>Creating a save system</Link>
*   <Link href={"#desktop-vs-mobile-experiences"}>Creating different experiences for desktop and mobile</Link>
*   <Link href={"#creating-multiple-endings"}>Creating multiple endings</Link>
*   <Link href={"#pause-and-mute"}>Settings buttons - pause & mute</Link>
...
```bash
    ...
    │       ├── bandit-missile.webp
    │       ├── bandit.webp
    │       ├── canyon-runner-splash.webp
    │       ├── cry-about-it-button.webp
    │       ├── down-arrow.webp
    │       ├── explosion1.webp
    │       ├── explosion10.webp
    │       ├── explosion11.webp
    ...
    │       ├── explosion8.webp
    │       ├── explosion9.webp
    │       ├── fire-missile-button-desktop.webp
    │       ├── fire-missile-button-mobile.webp
    │       ├── fire1.webp
    │       ├── fire2.webp
    │       ├── fire3.webp
    │       ├── happy-splashscreen.webp
    │       ├── healthkit.webp
    │       ├── healthorb1.webp
    │       ├── healthorb2.webp
    │       ├── healthorb3.webp
    │       ├── home-burning.webp
    │       ├── how-to-play-desktop.webp
    │       ├── how-to-play-mobile.webp
    │       ├── inverted-rock.webp
    │       ├── kaboom.webp
    │       ├── left-arrow.webp
    │       ├── missile.webp
    │       ├── navigation-bandit.webp
    │       ├── navigation-home.webp
    │       ├── navigation-supply.webp
    │       ├── pause-button.webp
    │       ├── play-again-button.webp
    │       ├── progress.webp
    │       ├── right-arrow.webp
    │       ├── rock.webp
    │       ├── rocket-sprite.webp
    │       ├── sad-splashscreen.webp
    │       ├── scrap1.webp
    │       ├── scrap2.webp
    │       ├── scrap3.webp
    │       ├── scrap4.webp
    │       ├── share-the-love-button.webp
    │       ├── smoke-puff.webp
    │       ├── sound-icon.webp
    │       ├── sprites.json
    │       ├── sprites.webp
    ...
    │   └── stylesheet.css
    ├── icons
    │   ├── app_icon_1024x1024.webp
    │   ├── app_icon_114x114.webp
    │   ├── app_icon_120x120.webp
    │   ├── app_icon_144x144.webp
    │   ├── app_icon_152x152.webp
    │   ├── app_icon_256x256.webp
    │   ├── app_icon_512x512.webp
    │   ├── app_icon_57x57.webp
    │   ├── app_icon_60x60.webp
    │   ├── app_icon_72x72.webp
    │   └── app_icon_76x76.webp
...
<h2 id="project-root">Project root</h2>
    ...
    module.exports = function(grunt) {
      ...
      grunt.initConfig({
        ...
        exec: {
          ...
          copyFavicon: 'cp ./assets/favicon.webp ./CanyonRunner-distribution/assets',

          copyAudio: "cp ./assets/audio/{audio.ogg,audio.m4a,audio.json} ./CanyonRunner-distribution/assets/audio",

          copySprites: "cp ./assets/sprites/{sprites.webp,sprites.json} ./CanyonRunner-distribution/assets/sprites",

          copyBackgrounds: "cp ./assets/backgrounds/{desert-open.webp,level1-background.webp,level2-background.webp,level3-background.webp,sad-desert.webp} ./CanyonRunner-distribution/assets/backgrounds",
...
`build`. This directory is home to the files that are required by our game to work, such as the actual Phaser framework files. Our build tool gathers up only what is needed from here when creating a distribution.
...
`images`. This directory holds a special image required by Phaser to render the screen telling the user they should rotate their phone to landscape mode in order to play the game. When phaser detects that the user's phone is being held upright, this image is used to render that hint on screen.
...
<h2 id="creating-a-preloader">Creating a preloader</h2>
...
```javascript
    ...
    CanyonRunner.Preloader.prototype = {
        ...
        preload: function () {
            ...
            this.game.load.image('desert-open', 'assets/backgrounds/desert-open.webp');
            this.game.load.image('sad-desert', 'assets/backgrounds/sad-desert.webp');
            this.game.load.image('dark-forest', 'assets/backgrounds/level3-background.webp');
            this.game.load.image('desert', 'assets/backgrounds/level1-background.webp');
            this.game.load.image('desert2', 'assets/backgrounds/level2-background.webp');
...
<h2 id="creating-a-splashscreen">Creating a splash screen</h2>
...
<h2 id="linking-separate-levels">Handling transitions between levels</h2>
...
<h2 id="creating-a-user-save-system">Creating a game save system</h2>
...
<h2 id="desktop-vs-mobile-experiences">Creating different experiences for desktop and mobile devices</h2>
...
<h2 id="creating-multiple-endings">Creating multiple endings depending upon player performance</h2>
...
<h2 id="creating-multiple-endings">Creating multiple endings</h2>
...
```
<h2 id="pause-and-mute">Settings buttons - pause & mute</h2>
