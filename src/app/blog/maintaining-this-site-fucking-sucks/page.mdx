...
import sisyphus from '@/images/sisyphus-crt-monitor-2.png'
...
<Image src={sisyphus} alt="Me working on the previous iteration of this website, which I mostly hand-rolled" />
