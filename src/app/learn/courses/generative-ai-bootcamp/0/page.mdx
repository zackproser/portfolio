...
On the one hand, It's really hard to write production-ready code that handles the business requirements correctly and that also is workable by other humans, but on the other hand, the models and templates are improving every day.
