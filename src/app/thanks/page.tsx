...
export const metadata: Metadata = {
  title: 'Thank You — Your Preferences Are Updated | Modern Coding',
  description:
      ...
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <div className="space-y-4">
            <Link
              href="/best-ai-tools"
              className="w-full flex justify-center py-3 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-amber-500 hover:bg-amber-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-amber-500 transition-colors duration-200"
            >
              Explore: Best AI Tools for Small Business
            </Link>
