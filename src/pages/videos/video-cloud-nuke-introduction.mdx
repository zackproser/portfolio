...
import cloudNukeIntro from '@/images/cloud-nuke-intro.png'

export const meta = {
  author: "Zachary Proser",
  date: "2022-01-01",
  title: "Cloud-Nuke - A Handy Open-Source Tool for Managing AWS Resources ",
  ...
  image: cloudNukeIntro
 }

export default (props) => <ArticleLayout meta={meta} {...props} />

<iframe width="315" height="315" src="https://www.youtube.com/embed/EMcqH495iGs" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
