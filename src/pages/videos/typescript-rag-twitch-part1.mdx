...
import ragPart1 from '@/images/typescript-rag-livestream-part1.png'

export const meta = {
  author: "Zachary Proser",
  date: "2023-08-10",
  title: "Live code review: Pinecone Vercel starter template and Retrieval Augmented Generation (RAG).",
...
<iframe width="315" height="315" src="https://www.youtube.com/embed/pPbTzgUV-UA" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
