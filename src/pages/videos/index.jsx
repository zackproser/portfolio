  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="All of my latest Twitch streams, YouTube videos, how-tos, demos, and code walkthroughs"
        />
      </Head>
      <SimpleLayout
        title="Zachary Proser's Videos"
        intro="All of my latest Twitch streams, YouTube videos, how-tos, demos, and code walkthroughs"
      >
