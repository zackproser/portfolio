...
import neovimDevDiary from '@/images/neovim-dev-diary-image.png'

export const meta = {
  author: "Zachary Proser",
  date: "2023-01-23",
  title: "Exploring a Custom Terminal-Based Developer Workflow -  Tmux, Neovim, Awesome Window Manager, and More",
  ...
  image: neovimDevDiary
}

export default (props) => <ArticleLayout meta={meta} {...props} />

<iframe width="315" height="315" src="https://www.youtube.com/embed/04ris-7sFAw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
