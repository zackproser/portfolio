...
import hackerReviewingCode from '@/images/hacker-reviewing-code.png'
import hackerReviewingCode2 from '@/images/hacker-reviewing-code-2.png'
...
export const meta = {
  ...
  image: hackerReviewingCode
}

export default (props) => <ArticleLayout meta={meta} {...props} />

<Image src={hackerReviewingCode2} alt="Hacker reviewing code in his terminal" />
...
<iframe width="315" height="315" src="https://www.youtube.com/embed/0VbWVNWeo7M" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
