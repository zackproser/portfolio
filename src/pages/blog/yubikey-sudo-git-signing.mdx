...
This is an important step to take if you participate in open source development because it is trivially easy to [spoof someone's git commits](https://blog.gruntwork.io/how-to-spoof-any-user-on-github-and-what-to-do-to-prevent-it-e237e95b8deb) without this extra layer of verification protection in place. 
...
### Step 3. Tell git to use the Yubikey-contained private key for commit signing 
...
## Configure Automatic GitHub commit signing with your Yubikey
