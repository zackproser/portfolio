...
And yet, we are ambitious software developers, technologists, and creators looking to share knowledge. We actively seek opportunities to stream our terminal, whether it's to our team when working through an issue together,  or to thousands of people in real-time on Twitch or YouTube.
