...
import opengraphFallbackImg from '@/images/og.png'
import opengraphPreview from '@/images/opengraph-preview.png'
import opengraphSequence from '@/images/opengraph-sequence.png'
...
src={`${process.env.NEXT_PUBLIC_SITE_URL}/api/og
    ...
    &image=/_next/static/media/retrieval-augmented-generation.2337c1a1.png`}
```

<Image 
    width={1200}
    height={630}
    src={`${process.env.NEXT_PUBLIC_SITE_URL}/api/og?title=Retrieval Augmented Generation (RAG)&image=/_next/static/media/retrieval-augmented-generation.2337c1a1.png`} 
...
src={`${process.env.NEXT_PUBLIC_SITE_URL}/api/og
    ...
    &image=/_next/static/media/javascript-ai.71499014.png`}
```

<Image 
    width={1200}
    height={630}
    src={`${process.env.NEXT_PUBLIC_SITE_URL}/api/og?title=A-powered and built with...JavaScript?&image=/_next/static/media/javascript-ai.71499014.png`} 
