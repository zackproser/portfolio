...
import nextJsOverview from '@/images/next-js-overview.png'
import tailwindUI from '@/images/tailwind-ui.png'
import vercelHomepage from '@/images/vercel-homepage.png'
