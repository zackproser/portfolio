...
import joiningPinecone from '/public/joining-pinecone.png'
import pineconeVectorDatabases from '@/images/pinecone-vector-databases.png'
import technicalStorytelling from '@/images/technical-storytelling.png'
import pineconeHiring from '@/images/pinecone-hiring.png'
...
<Link href={"https://pinecone.io"}>Pinecone.io</Link> makes the world's best vector database, which is essential for storing and efficiently querying embeddings. Vector databases are **critical infrastructure** in the midst of the 
