...
<figcaption>A developer watching the API key they accidenally committed to GitHub migrating throughout the internet - thinking of the Slack messages they're about to have to send...</figcaption>
