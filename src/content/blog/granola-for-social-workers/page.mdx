...
<AffiliateLink product="granola" campaign={campaign}>Granola gives new users their first three months free</AffiliateLink>, enough time to test the workflow across a full quarter of meetings. For social workers, we recommend starting with team coordination meetings and supervision sessions — lower-stakes contexts where you can evaluate the quality of Granola's output before using it with clients.
