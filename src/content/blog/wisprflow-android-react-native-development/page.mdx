...
export const campaign = 'wisprflow-android-react-native-development';
...
<AffiliateLink product="wisprflow" campaign={campaign}>Try WisprFlow for React Native development</AffiliateLink> and see how voice coding accelerates cross-platform mobile app development workflows.