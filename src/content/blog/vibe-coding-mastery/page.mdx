...
import simpleGitFlow from '@/images/simple-git-flow.webp'
import gitBranches from '@/images/git-branches.webp'
import gitCommit from '@/images/git-commit.webp'
import gitSharing from '@/images/git-sharing.webp'
import gitTimeline from '@/images/git-timeline.webp'
import gitGuardian from '@/images/git-guardian-flow.webp'
...
import cursorRules from '@/images/cursor-rules.webp'
...
This guide is built to be used *as you build*. Each section is short and it keeps you safe from costly mistakes.

Here's how to use it:
- **Follow the sections in order**: Git → Secrets → Cursor → Deploy
- **Use the screencasts** if you feel stuck
- **Copy-paste** the ommands – they're designed to work out of the box
- **Install the Cursor rules** to get real-time help in your editor
- When in doubt, head to [Emergency Recovery] or [contact me](/contact)

# ⎇ Git: Your software save system 

<Image src={introToGit} alt="Git is a save system that also helps you share your software" />
...
<Image src={gitCommit} alt="" />

Checkpoints of your project. You create them when you've made meaningful changes. For example, adding a new feature or capability to your application.
...
<Image src={gitBranches} alt="" />

Parallel universes for your code. You can create a branch to try out new ideas without messing up your main working version.
...
<Image src={gitSharing} alt="Git is also for sharing your software with other developers and deployment platforms" />

(GitHub/GitLab etc.):** Repositories aren't just for saving; they let you share your code and collaborate with others using platforms like GitHub. Services like Vercel can also deploy directly from these platforms.
...
<Image src={gitTimeline} alt="Git is like a time machine" />
...
<Image src={simpleGitFlow} alt="The standard git workflow while developing" />

While you work on your project, make commits regularly. 

Most developers make TOO FEW commits while working, thereby failing to give themselves enough meaningful save points. You can 
make a commit every few minutes as you get new functionality working.

The standard git flow is the following: 
* Make some changes to your application
* "Stage" the files by adding them
* Commit and add a message creating a save point 
* Run git push to save your work to a local remote, which can be restored even if you lose your current laptop

### Your First Safe Commit & Push

<Image src={gitPopped} alt="Most secrets leaks happen because people don't realize .env is being committed to git" />
...
This connects your local project to GitHub and pushes your code up to the cloud. Now your work is safely backed up and ready to share or deploy!
...
<Image src={secretsVsNonSecrets} alt="Diagram showing examples of secrets like API keys and passwords versus non-secrets like feature flags and public URLs" />
...
<Image src={gitignore} alt="How .gitignore protects your secrets from being committed to Git" className="my-6" />
...
🎬 **[Screen Recording Needed]: Trying to commit a filecontaining a fake API key and showing how GitGuardian blocks it.**

### Setting Up Cursor Rules for Safety and Mentorship

<Image src={cursorRules} alt="Cursor rules" />
