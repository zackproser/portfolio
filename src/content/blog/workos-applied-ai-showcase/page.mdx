...
<video controls playsInline className="w-full rounded-xl my-6">
  <source src="https://zackproser.b-cdn.net/images/WorkOS.mp4" type="video/mp4" />
</video>

Or watch the full session — the embed below jumps straight to my segment (1:02:45 to about 1:17:23):
