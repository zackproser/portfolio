...
Granola gives new users their first 3 months free, and WisprFlow offers a free trial:

**Granola**: <AffiliateLink product="granola" campaign={campaign}>Get your first 3 months free</AffiliateLink> — Syncs with your calendar. The next meeting on your schedule is captured automatically. See the [Granola vs Otter comparison](/blog/granola-vs-otter) for how it stacks up.
