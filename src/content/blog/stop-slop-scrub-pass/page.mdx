...
This post ran the pass. The first run returned eleven hits and a HIGH long-dash count; the final run returned zero. I want the PR button disabled until the page no longer smells like a model. That is what [completing the loop](/blog/workos-applied-ai-showcase) looks like up close: the agent does the typing, the gate refuses the bad drafts, and I keep the judgment.
