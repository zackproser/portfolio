...
The list I use is [stop-slop](https://github.com/hardikpandya/stop-slop), an open-source catalog of the phrases and structures that mark AI-generated prose. I wired it into my blog pipeline as its own pass. This post is the test case: the same pipeline drafted it, then ran the pass on it. The first run failed, which I'll show you. Here's how to build the step.
