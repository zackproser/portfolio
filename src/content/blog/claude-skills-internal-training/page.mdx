...
**Cloud Internal Skills Training** — I'll come to your team (in-person or remote) and run the same kind of session you just read about. We pick a real workflow your team needs, build it into a shareable Claude skill together, and everyone leaves with a working capability they can iterate on.

**Cloud Co-Work Sessions** — Think of it as a focused working session where I pair with your engineers on their actual AI challenges. We ship real code, solve real problems, and your team levels up in the process.
