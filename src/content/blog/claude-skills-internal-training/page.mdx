...
What makes skills unique is their dual legibility. The SKILL.md file that Claude reads to understand the workflow? You can read it too. It's plain English instructions alongside the actual implementation code.
This means:
...
I run hands-on workshops and co-working sessions to help engineering teams build real AI skills — not just theory, but actual workflows they'll use daily.

**Claude Internal Skills Training** — I'll come to your team (in-person or remote) and run the same kind of session you just read about. We pick a real workflow your team needs, build it into a shareable Claude skill together, and everyone leaves with a working capability they can iterate on.

**Claude Cowork Sessions** — Think of it as a focused working session where I pair with your engineers on their actual AI challenges. We ship real code, solve real problems, and your team levels up in the process.

**Full AI Engineering Program** — A structured 90-day program that takes your developers from AI fundamentals through production deployment. Money-back guarantee if your team doesn't ship an AI feature.

<a href="/ai-training" className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-6 rounded-lg transition-colors no-underline">
