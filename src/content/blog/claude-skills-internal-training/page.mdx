...
I run hands-on workshops and coworking sessions to help engineering teams build real AI skills — not theory, but actual workflows they'll use daily.

**Claude Internal Skills Training** — I come to your team (in-person or remote) and we build a real Claude skill together from one of your actual workflows. Everyone leaves with a working, shareable capability.

**Claude Cowork Sessions** — I pair with your engineers on their actual AI challenges. We ship real code, solve real problems, and your team levels up by doing.

**Full AI Engineering Program** — A structured 90-day program from foundations through production deployment. Money-back guarantee.
