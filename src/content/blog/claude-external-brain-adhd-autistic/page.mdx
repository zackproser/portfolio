...
<Image src="https://zackproser.b-cdn.net/images/claude-chat.webp" alt="Conversation with Claude acting as an external executive function" width={800} height={600} />
<figcaption>Programming compassionate constraints into Claude keeps me shipping instead of spiraling.</figcaption>
...
<figcaption>Diffuse‑mode thinking on trail; agents keep work moving.</figcaption>
...
<Image src="https://zackproser.b-cdn.net/images/wisprflow-interface.webp" alt="Wispr Flow interface recording and transcribing" width={800} height={600} />
<figcaption>High‑accuracy dictation turns spoken intent into structured work.</figcaption>
...
<Image src="https://zackproser.b-cdn.net/images/git-guardian-flow.webp" alt="Secret scanning and CI guardrails" width={800} height={600} />
<figcaption>Defense‑in‑depth: pre‑commit and CI scanners keep velocity safe.</figcaption>
