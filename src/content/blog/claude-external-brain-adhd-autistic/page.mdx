...
*DevSecCon 2025 Keynote — Orchestrating Intelligence: Voice, Agents, and CI for Safer Speed. Use AI to free yourself from the desk by pushing machine‑friendly work through a hardened pipeline while you do deep thinking where you think best. This post extends that talk and the personal story I shared in [In the LLM, I Saw Myself](/blog/in-the-llm-i-saw-myself), showing how I use Claude as my external brain as an autistic person with severe ADHD.*
