...
| Free access | 3 months for new users | Yes | Yes | No |
...
<AffiliateLink product="granola" campaign={campaign}>Get your first three months of Granola free</AffiliateLink> - the new-user offer gives you a full quarter to evaluate it in real meetings.
