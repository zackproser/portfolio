...
<Image src="https://zackproser.b-cdn.net/images/the-agent-fleet-full-presence.jpg" alt="Pixel art split scene: on one side a parent fully present on the floor playing with two small kids while a phone and laptop sit dark and face-down on a far shelf; on the other side a tidy fleet of small robot workers quietly handling mail, calendar, and drafts on their own" width={1200} height={675} />
