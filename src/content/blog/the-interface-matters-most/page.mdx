...
Ten seconds. That's the window. If your AI feature asks me to sign up, log in, find the right page, read the onboarding, and *then* start solving my problem — I'm already gone.
...
<Image src="https://zackproser.b-cdn.net/images/interface-matters-bartleby.webp" alt="Pixel art of an abandoned login screen with cobwebs — Bartleby the scrivener standing beside it" width={1200} height={675} />
<figcaption>Bartleby preferred not to. So did my users. <Link href="/speaking/workos-applied-ai-showcase">Play the slide deck.</Link></figcaption>
...
<Image src="https://zackproser.b-cdn.net/images/interface-matters-joy.webp" alt="A person leaning back relaxed as their screen shows a glowing progress bar completing with sparkles" width={1200} height={675} />
