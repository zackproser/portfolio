...
Ten seconds. That's the window. If your AI feature asks me to sign up, log in, find the right page, read the onboarding, and *then* start solving my problem — I'm already gone. I closed the tab. I'm back in Slack doing whatever I was doing before someone told me about your tool.

I've been shipping AI tooling internally at WorkOS for eighteen months. I've built the same product twice, with two different interfaces, and watched one die in silence while the other got adopted in a week. The difference had nothing to do with models, prompts, or architecture. It had everything to do with where the door was.
