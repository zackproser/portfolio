...
Grouped-query attention lowers **H**<sub>kv</sub> below the query-head count, which is why the cache formula needs KV heads rather than total attention heads. The GQA paper describes converting multi-head checkpoints to fewer KV heads. The model configuration, not its marketing size, supplies the ledger inputs.
...
Standard attention materializes or repeatedly moves intermediates between high-bandwidth memory and faster on-chip memory. FlashAttention tiles queries, keys, and values, computes attention blocks on chip, and maintains the softmax statistics needed to combine tiles exactly. The result changes memory traffic and temporary storage without approximating dense attention. IO-awareness matters because fewer floating-point operations do not guarantee less wall-clock time when data movement is the limiting resource.
...
<BpReferences
  drawingCode="TDD-011"
  items={[
    { label: 'Kwon et al., “Efficient Memory Management for Large Language Model Serving with PagedAttention,” SOSP 2023', href: 'https://arxiv.org/abs/2309.06180' },
    { label: 'Dao et al., “FlashAttention: Fast and Memory-Efficient Exact Attention with IO-Awareness,” NeurIPS 2022', href: 'https://arxiv.org/abs/2205.14135' },
    { label: 'Xiao et al., “SmoothQuant: Accurate and Efficient Post-Training Quantization for Large Language Models,” ICML 2023', href: 'https://arxiv.org/abs/2211.10438' },
    { label: 'Yu et al., “Orca: A Distributed Serving System for Transformer-Based Generative Models,” OSDI 2022', href: 'https://www.usenix.org/conference/osdi22/presentation/yu' },
    { label: 'Agrawal et al., “SARATHI: Efficient LLM Inference by Piggybacking Decodes with Chunked Prefills,” 2023', href: 'https://arxiv.org/abs/2308.16369' },
    { label: 'Zhong et al., “DistServe: Disaggregating Prefill and Decoding for Goodput-optimized Large Language Model Serving,” OSDI 2024', href: 'https://arxiv.org/abs/2401.09670' },
    { label: 'Ainslie et al., “GQA: Training Generalized Multi-Query Transformer Models from Multi-Head Checkpoints,” EMNLP 2023', href: 'https://arxiv.org/abs/2305.13245' },
  ]}
/>
