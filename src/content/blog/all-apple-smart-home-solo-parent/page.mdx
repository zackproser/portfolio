...
<GearSpotlight
  ...
  why="The mesh that finally gave every camera, plug, and hub a stable connection — and let me work outside without the signal dying at the back wall. Everything else in the house depends on it."
...
<GearSpotlight
  ...
  why="Weather-rated, fence-mounted, and the true-color night vision is genuinely the best thing in the setup. At 11 PM the backyard reads like midday."
...
These do a different job than the kid cameras. Package deliveries, visitors, the occasional person I don't recognize coming up the driveway — I get all of it as a notification on my watch before they ever press the bell. That matters when both kids are napping and a doorbell chime would undo an hour of work.
...
<Image src="https://zackproser.b-cdn.net/images/apple-devices-camera-montage-v3.webp" alt="Pixel art showing the same grid of indoor and outdoor camera feeds mirrored across an Apple Watch, an iPhone, a MacBook, and a floating Vision Pro window, all connected by glowing lines to a single Home app" width={1200} height={1200} />
...
There's a white-noise water fountain in my bedroom that helps me sleep. Running it 24 hours a day wastes power and burns out the pump, so it's on a [Linkind Matter smart plug](https://www.amazon.com/dp/B0C36WXGP1/?tag=zackproser-20) automated through the Home app: on at 10 PM, off at 7 AM, never touched. Two more plugs run the outdoor bug zappers on an evening-to-morning schedule, so they zap when it matters and shut off during the day when nobody's outside.

The plugs come four to a pack for the price of a couple of coffees, and the Home app's automation layer is basic but reliable for timed schedules. For fountains and bug zappers, that's all I need.
...
**Govee lights.** I have [Govee smart light strips](https://www.amazon.com/dp/B0D7MHH79D/?tag=zackproser-20) waiting to go into every room. Once they're added to HomeKit, walking through the house at night with a toddler on my hip stops meaning fumbling for switches in the dark.
...
<Image src="https://zackproser.b-cdn.net/images/smart-home-future-upgrades-v2.webp" alt="Pixel art blueprint-style floor plan glowing on a dark background, with dotted lines marking planned additions: motion sensors in hallways, smart light bulbs in each room, and arrows connecting sensors to lights" width={1200} height={1200} />
...
I built the right house. I'm waiting on the software to catch up to it. In the meantime the cameras work, the network holds, the automations run, and the bug zappers turn themselves off — and from any screen in or out of the house, I can open one app and see that my kids are exactly where they should be. That's enough to make this place a paradise. It would be a better one if Siri would just do her job.
