...
<Image src="https://zackproser.b-cdn.net/images/apple-smart-home-hero-v4.webp" alt="Pixel art isometric cutaway of a two-story house at night: a single parent kneeling with two toddlers playing by the fireplace in the living room, a glowing camera in each room, a bunk bed upstairs, and cameras on the backyard fence by the swing set" width={1200} height={1200} />
...
So I added one [eero 7 set](https://www.amazon.com/dp/B0D955ZMSR/?tag=zackproser-20): the main unit wired by Ethernet to the router downstairs, a second in my upstairs office, a third in my upstairs bedroom — plus one [eero Outdoor 7](https://www.amazon.com/dp/B0CHJBJLHN/?tag=zackproser-20) node for the yard and the patio.
...
<GearSpotlight
  ...
  name="eero 7 (3-pack) + eero Outdoor 7"
  why="A three-unit set gave every camera, plug, and hub a stable connection, and the outdoor node blankets the entire yard — more coverage than I need, full signal everywhere outside."
  specs={["Wi-Fi 7", "3 indoor units", "IP66 outdoor node"]}
...
Every camera — indoor, outdoor, both doorbells — lands in one Home app, and that app is everywhere I am. On my Apple Watch when I'm in another room. On my Vision Pro, pulled up with my voice in the middle of a show or a <Link href="/blog/play-steam-link-vision-pro-while-watching-tv">gaming session</Link>. On my laptop when I'm working on the patio during naptime and think I hear someone stirring inside. I launch one app and see the entire house, inside and out, on a single screen.
...
<ReadNextCard
  ...
  imageAlt="Wearing the Vision Pro on the couch with an Xbox controller, a TV show on one floating screen and a game on another"
  title="How to Play Steam Link on Vision Pro While Watching TV"
  description="The same spatial-computing setup that lets me check the cameras mid-show is what I use to game on a giant virtual screen and watch TV at the same time. Here's the full rig and how to wire it up."
  href="/blog/play-steam-link-vision-pro-while-watching-tv"
/>
...
<Image src="https://zackproser.b-cdn.net/images/home-app-remote-access-v1.webp" alt="Pixel art diagram of secure remote Home app access: a traveler with a phone beside a globe on the left, an end-to-end-encrypted path marked with padlocks and a key leading through a locked cloud relay in the center, into a home with a hub puck that fans out to the cameras on the right" width={1200} height={1200} />
...
<Image src="https://zackproser.b-cdn.net/images/siri-homepod-mini-fail-v4.webp" alt="Pixel art of a HomePod mini glowing on a shelf next to a television that is playing a show, a voice command floating toward it, and the response coming back as a dim error glyph instead of an action" width={1200} height={1200} />
