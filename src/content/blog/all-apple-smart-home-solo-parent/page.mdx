...
<Image src="https://zackproser.b-cdn.net/images/apple-devices-camera-montage-v4.webp" alt="Premium product render on a dark background: an orange iPhone 17 Pro Max, an orange Apple Watch Ultra, an Apple Vision Pro panel, and a slate 14-inch MacBook Pro all showing the same grid of indoor and outdoor camera feeds, connected by glowing cyan threads to a single home icon" width={1200} height={1200} />
