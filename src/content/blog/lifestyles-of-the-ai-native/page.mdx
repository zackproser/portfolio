...
<Image src="https://zackproser.b-cdn.net/images/aie-sf-2026-live-board.jpg" alt="The live board UI: where the room walked in, the migration from manual to automated, and the top hooks and scheduled tasks named by the room" width={1200} height={675} />

<span className="text-xs text-zinc-400 dark:text-zinc-500">The board — every panel driven by the room's own check-ins.</span>
...
<span className="text-xs text-zinc-400 dark:text-zinc-500">The glossary — every term from the deck, plus a chat that answers questions about any of them.</span>
