...
export const { Cite, References } = makeCitations([
  { id: 'greshake-2023-injection', label: 'Greshake et al., “Not what you’ve signed up for: Compromising Real-World LLM-Integrated Applications with Indirect Prompt Injection,” arXiv:2302.12173v2, May 5, 2023', href: 'https://arxiv.org/abs/2302.12173' },
  { id: 'owasp-llm-top10', label: 'OWASP Foundation, “OWASP Top 10 for Large Language Model Applications,” project page (accessed July 19, 2026)', href: 'https://owasp.org/www-project-top-10-for-large-language-model-applications/' },
  { id: 'owasp-llm-top10-v2025', label: 'OWASP Foundation, “OWASP Top 10 for LLM Applications v2.0,” 2025 edition', href: 'https://owasp.org/www-project-top-10-for-large-language-model-applications/assets/PDF/OWASP-Top-10-for-LLMs-v2025.pdf' },
  { id: 'debenedetti-2024-agentdojo', label: 'Debenedetti et al., “AgentDojo: A Dynamic Environment to Evaluate Prompt Injection Attacks and Defenses for LLM Agents,” arXiv:2406.13352v3, November 24, 2024', href: 'https://arxiv.org/abs/2406.13352' },
  { id: 'nist-caisi-hijacking', label: 'NIST CAISI, “Technical Blog: Strengthening AI Agent Hijacking Evaluations,” January 17, 2025; updated December 19, 2025', href: 'https://www.nist.gov/news-events/news/2025/01/technical-blog-strengthening-ai-agent-hijacking-evaluations' },
])
...
**Indirect prompt injection** arrives inside data the agent retrieves: a message, document, website, issue, calendar entry, or tool response. Greshake and coauthors named and demonstrated this remote route in arXiv 2302.12173<Cite id="greshake-2023-injection" />, first submitted February 23, 2023 and revised May 5, 2023. Their durable observation is the blurred instruction/data distinction in LLM-integrated applications. The defensive consequence is to inventory every source that can enter context and every effect reachable afterward.
...
<BpFigure caption="FIG. 3 — HERO ROUTE: HOSTILE DOCUMENT → MODEL CONTEXT → PRIVILEGED TOOL CALL. THE FIRST TWO HOPS MOVE INFORMATION; THE LAST HOP SPENDS AUTHORITY.">
  <svg viewBox="0 0 920 410">
    ...
    <g className="bp-svg-t11" fill="currentColor">
      ...
      <text x={690} y={171}>CALENDAR · EMAIL · FILES</text><text x={690} y={194}>PAYMENTS · CODE</text><text x={690} y={217}>EXTERNAL EFFECT</text>
      <text x={370} y={330}>AUTHORIZATION SERVICE</text><text x={370} y={352}>PRINCIPAL + TASK + ACTION + SCOPE + EXPIRY</text>
    </g>
...
The 2025 OWASP Top 10 for LLM Applications<Cite id="owasp-llm-top10" /> lists prompt injection as LLM01 and excessive agency as LLM06<Cite id="owasp-llm-top10-v2025" />. Those dated names help a review connect model influence to permission design. The permanent model here avoids depending on list numbers: untrusted sources enter a deputy, and an enforcement point decides whether the deputy may create an effect.
...
<References drawingCode="TDD-012" />
