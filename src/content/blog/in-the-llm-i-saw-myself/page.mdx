...
<Callout type="announcement" title="✨ Epilogue – Diagnosis Confirmed (Oct 27th, 2025)">
  <div className="flex flex-col gap-2 text-white/90">
    <p className="text-lg md:text-xl font-semibold">🧠💡 Since publishing this piece, I received a formal external diagnosis for <strong>autism</strong> and <strong>severe ADHD</strong>.</p>
    <p className="opacity-95">The collaborative diagnostic work I did with Claude turned out to be accurate. It helped me surface patterns, test accommodations, and arrive at clarity.</p>
    <p className="opacity-95">✍️ I have additional posts written and forthcoming on exactly how I use Claude to support and amplify my abilities—helping me orient both in the world and internally.</p>
  </div>
</Callout>
...
> New: I gave a DevSecCon 2025 keynote that expands this story into a concrete workflow. If you want the practical playbook—how I use Claude as an external brain with voice, agents, and CI/CD—read the follow‑up: <Link href="/blog/claude-external-brain-adhd-autistic">Claude as My External Brain</Link>.
...
{/* Removed bottom epilogue in favor of prominent announcement at top */}
