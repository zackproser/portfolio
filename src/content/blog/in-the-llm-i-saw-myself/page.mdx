...
<Callout type="info" className="ring-0 border-white/20 mt-6">
  <div className="flex items-start gap-3 text-white">
    ...
    <div className="flex-1">
      <div className="font-semibold text-lg md:text-xl">Diagnosis confirmed — Oct 27th 2025</div>
      <p className="text-white/90 mt-1">Since writing this, I received a formal external diagnosis for <strong>autism</strong> and <strong>severe ADHD</strong>. The diagnostic work I did with Claude reflected my neurology accurately.</p>
      <p className="text-white/90 mt-1">I also have additional posts written and forthcoming about how I use Claude to support me and enhance my abilities—helping me orient in the world and internally.</p>
    </div>
  </div>
</Callout>
