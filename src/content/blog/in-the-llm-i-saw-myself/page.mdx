...
- I tested into gifted and talented programs as a kid
- I scored a perfect mark on a memory assessment that surprised the adults in the room
- I obsessively memorized entire poems and short stories because it felt important to retain the whole, not just the gist
- Despite being self‑taught, I routinely delivered abnormal performance in software development—shipping complex systems, moving faster than peers, and holding larger problem graphs in working memory
...
Separately, Tom told me the key wasn’t luck; it was how I think. I break problems down to atomic units until the model is clean, then recompose—repeat. That pattern shows up everywhere for me. It’s not a fluke; it’s an operating system.
