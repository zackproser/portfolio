...
export const campaign = 'wisprflow-android-development-workflow';
...
<AffiliateLink product="wisprflow" campaign={campaign}>Try WisprFlow for Android development</AffiliateLink> and see how voice coding accelerates your mobile app development workflow.