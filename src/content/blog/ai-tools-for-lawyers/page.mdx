...
export const campaign = 'ai-tools-for-lawyers';
...
<AffiliateLink product="wisprflow" campaign={campaign}>WisprFlow</AffiliateLink> is a voice-to-text application that works system-wide on Mac. Speak naturally, and polished text appears wherever your cursor is focused—Word, Outlook, your document management system, anywhere.
...
<AffiliateLink product="granola" campaign={campaign}>Granola</AffiliateLink> captures meeting audio and generates structured notes without a bot joining your call. This distinction matters significantly in legal contexts.
...
**WisprFlow**: <AffiliateLink product="wisprflow" campaign={campaign}>Try free</AffiliateLink> - Install takes 2 minutes. Start with email dictation to build comfort.

**Granola**: <AffiliateLink product="granola" campaign={campaign}>Get three months free</AffiliateLink> - New users can sync their calendars and generate notes from real meetings for a full quarter before paying.
