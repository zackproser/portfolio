...
<Image src="https://zackproser.b-cdn.net/images/live-coding-assist-hero.webp" alt="Hero image illustrating the journey of overcoming live coding interview anxiety through AI-assisted practice and systematic desensitization" width={800} height={600} />
...
<Image src="https://zackproser.b-cdn.net/images/advanced-voice-video.webp" alt="ChatGPT advanced voice mode interface showing video feed capability with a smartphone displaying the conversation screen" width={800} height={600} />
...
<NewsletterWrapper 
  title="Want More AI-Powered Career Breakthroughs?"
  body="Join 35,000+ developers getting my latest tutorials on using AI to level up your engineering skills and overcome technical challenges. No fluff, just actionable insights that actually work."
  successMessage="Welcome to the community! You'll get my best AI engineering tips and real-world breakthroughs like this one."
  tags={["coding-anxiety", "ai-assistance", "career-growth"]}
  position="mid-article"
/>

## The ChatGPT on your phone setup

<Image src="https://zackproser.b-cdn.net/images/chatgpt-setup.webp" alt="Smartphone with ChatGPT app open positioned to view a computer screen showing a Jupyter notebook for live coding practice" width={800} height={600} />
...
<Image src="https://zackproser.b-cdn.net/images/goose-neck-clamp.webp" alt="Flexible goose neck clamp holding a smartphone in position to view a computer monitor for hands-free video streaming" width={800} height={600} />
...
<Image src="https://zackproser.b-cdn.net/images/google-ai-studio-stream.webp" alt="Google AI Studio interface showing the live stream feature with video call controls and chat interface" width={800} height={600} />
...
<Image src="https://zackproser.b-cdn.net/images/ai-studio-share-screen.webp" alt="Browser screen sharing dialog showing Google Colab tab being shared with Google AI Studio for live coding assistance" width={800} height={600} />
<figcaption>Sharing only my Google Colab tab with AI Studio</figcaption>

<Image src="https://zackproser.b-cdn.net/images/ai-studio-watching.webp" alt="Google AI Studio interface showing live view of a shared Google Colab notebook with Python code visible on screen" width={800} height={600} />
...
<Image src="https://zackproser.b-cdn.net/images/dual-wield.webp" alt="Split screen view showing Google AI Studio video call interface alongside Google Colab notebook for simultaneous coding and AI conversation" width={800} height={600} />
...
<Image src="https://zackproser.b-cdn.net/images/training-montage.webp" alt="Conceptual illustration of systematic desensitization therapy showing gradual exposure to coding interview scenarios with decreasing anxiety levels" width={800} height={600} />
...
<Image src="https://zackproser.b-cdn.net/images/reboot.webp" alt="Conceptual illustration of mental reset and renewal, symbolizing overcoming coding interview anxiety and reclaiming confidence" width={800} height={600} />
