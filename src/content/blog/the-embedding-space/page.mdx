...
export const { Cite, References } = makeCitations([
  { id: 'harris-1954', label: 'Harris, "Distributional Structure", Word 1954', href: 'https://doi.org/10.1080/00437956.1954.11659520' },
  { id: 'mikolov-2013a', label: 'Mikolov et al., "Efficient Estimation of Word Representations in Vector Space", ICLR 2013', href: 'https://arxiv.org/abs/1301.3781' },
  { id: 'mikolov-2013b', label: 'Mikolov et al., "Distributed Representations of Words and Phrases and their Compositionality", NeurIPS 2013', href: 'https://arxiv.org/abs/1310.4546' },
  { id: 'pennington-2014', label: 'Pennington, Socher, and Manning, "GloVe: Global Vectors for Word Representation", EMNLP 2014', href: 'https://aclanthology.org/D14-1162/' },
  { id: 'reimers-2019', label: 'Reimers and Gurevych, "Sentence-BERT: Sentence Embeddings using Siamese BERT-Networks", EMNLP-IJCNLP 2019', href: 'https://arxiv.org/abs/1908.10084' },
  { id: 'oord-2018', label: 'Oord, Li, and Vinyals, "Representation Learning with Contrastive Predictive Coding", 2018', href: 'https://arxiv.org/abs/1807.03748' },
  { id: 'gao-2021', label: 'Gao, Yao, and Chen, "SimCSE: Simple Contrastive Learning of Sentence Embeddings", EMNLP 2021', href: 'https://arxiv.org/abs/2104.08821' },
  { id: 'malkov-2018', label: 'Malkov and Yashunin, "Efficient and Robust Approximate Nearest Neighbor Search Using Hierarchical Navigable Small World Graphs", IEEE TPAMI 2018', href: 'https://arxiv.org/abs/1603.09320' },
])
...
The underlying idea predates neural networks. Zellig Harris argued in 1954 that differences in meaning correspond to differences in linguistic environments<Cite id="harris-1954" />. J. R. Firth compressed the intuition into the line most people remember: &quot;You shall know a word by the company it keeps.&quot; This **distributional hypothesis** turns surrounding language into evidence. If *physician* and *doctor* repeatedly appear beside patients, clinics, and treatment, their shared company reveals a relationship without a hand-written synonym entry.
...
That route became practical at scale with word2vec in 2013<Cite id="mikolov-2013a" />. Its skip-gram objective learned a word vector by predicting nearby words; the efficient training procedure produced useful geometry from huge text collections<Cite id="mikolov-2013b" />. GloVe followed in 2014<Cite id="pennington-2014" /> with an objective built from global word co-occurrence counts. Both assigned one vector to each vocabulary word, so *bank* had to occupy one location whether the sentence concerned money or a river.
...
Contrastive training turned this into a reusable recipe. Put related examples together, place many alternatives beside them, and ask the encoder to identify the matching partner. Work on contrastive predictive coding supplied the InfoNCE form used below<Cite id="oord-2018" />; later systems applied related losses across images, sentences<Cite id="gao-2021" />, and query-passage pairs at much larger batch and dataset scales. The resulting model learns a comparison space directly, rather than hoping a representation trained for another objective happens to rank well.
...
<References drawingCode="TDD-002" />
