...
export const campaign = 'wisprflow-vs-github-copilot-voice-vs-ai-completion';
...
<AffiliateLink product="wisprflow" campaign={campaign}>Try WisprFlow alongside your existing coding tools</AffiliateLink> and see how voice coding enhances your development workflow without replacing other AI assistance.