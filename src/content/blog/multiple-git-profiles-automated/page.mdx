...
export const metadata = createMetadata({
  title: "Automate Your Git Profile Switching Between Work and Personal Projects",
  description: "Never commit with the wrong Git profile again. Learn how to automatically switch between work and personal Git profiles based on your project directory.",
  keywords: ["Git", "profile switching", "automation", "work-life separation", "shell configuration"],
  author: "Zack Proser",
  date: "2023-10-27",
  image: "/images/multiple-git-profiles.webp",
  url: "https://zackproser.com/blog/multiple-git-profiles-automated",
  type: "article",
  tags: ["Git", "profile switching", "automation", "work-life separation", "shell configuration"],
  publisher: "Zack Proser",
  locale: "en_US",
  twitter: {
  ...
  openGraph: {
    ...
    type: "article",
    article: {
      publishedTime: "2023-10-27",
      modifiedTime: "2023-10-27",
      authors: ["Zack Proser"],
      tags: ["Git", "profile switching", "automation", "work-life separation", "shell configuration"]
    }
  },
