...
<Image src="https://zackproser.b-cdn.net/images/orchestrator-pattern.webp" alt="The orchestrator pattern - humans set goals, agents execute, safety systems validate" width={800} height={600} />
