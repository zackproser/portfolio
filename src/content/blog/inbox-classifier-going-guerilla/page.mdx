...
<Image src="https://zackproser.b-cdn.net/images/inbox-guerilla-buckets.webp" alt="Pixel-art scene: an envelope sorter routing templated cold outreach into one chute (auto-reply) and real personalized email into a separate chute reserved for human review" width={1200} height={675} />
...
<Image src="https://zackproser.b-cdn.net/images/inbox-guerilla-footer.webp" alt="Pixel-art scene: a signed letter at the bottom of a stack stamped with a small punchline tag — a fair-warning sticker attached only to bulk outreach" width={1200} height={675} />
