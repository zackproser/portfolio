...
- [Wispr Flow](https://ref.wisprflow.ai/zack-proser) for voice-driven everything ([detailed review](/blog/wisprflow-review))
...
[Wispr Flow](https://ref.wisprflow.ai/zack-proser) is the secret weapon that changed everything. I'm an above-average typist (90 WPM), but with voice through Wispr Flow, I hit 175 WPM consistently.
