...
export const campaign = 'granola-sales-team-call-transcription';
...
*Current challenges: Manual deployment process, 6-hour release cycles*
...
<AffiliateLink product="granola" campaign={campaign}>Get your first three months of Granola free</AffiliateLink> and see how AI-powered call transcription transforms your sales process and revenue outcomes.
