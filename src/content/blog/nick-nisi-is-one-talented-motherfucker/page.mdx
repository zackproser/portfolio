...
<Image src="https://zackproser.b-cdn.net/images/nick-nisi-presenting.webp" alt="Nick Nisi presenting 'Building AI Systems that Ship' on stage at AI Engineering London" width={1200} height={800} />
...
You might know Nick from co-hosting JS Party on the Changelog network. Or from organizing [NebraskaJS](https://nebraskajs.com/), [NEJS Conf](https://nejsconf.com/), and [TypeScript Conf](https://archive.tsconf.io/2021/). He's given 50+ conference talks. He's officiated eleven weddings, which tells you something about the kind of person people trust with their important moments.
...
So: [Nick Nisi](https://nicknisi.com). JS Party host. [NebraskaJS](https://nebraskajs.com/) organizer. TypeScript enthusiast. Wedding officiant. Conference veteran. Fucking animal.
