...
<BpSection id="s1" num="01" label="The problem" sheet="SHEET 1 OF 9" title="The shape of the problem" />
...
<BpSection id="s2" num="02" label="One table" sheet="SHEET 2 OF 9" title="One table, one interface" />
...
<BpSection id="s3" num="03" label="Distill" sheet="SHEET 3 OF 9" title="Distill, don't dump" />
...
<BpSection id="s4" num="04" label="Retrieval" sheet="SHEET 4 OF 9" title="Retrieval: three retrievers, a scorer, and a reranker I didn't want to build" />
...
<BpSection id="s5" num="05" label="The wall" sheet="SHEET 5 OF 9" title="The wall: enforced by the database, not by prompts" />
...
<BpSection id="s6" num="06" label="Failures" sheet="SHEET 6 OF 9" title="The failures that shaped it" />
...
<BpSection id="s7" num="07" label="Bootstrapping" sheet="SHEET 7 OF 9" title="Bootstrapping a new agent" />
...
<BpFigure caption="FIG. 5 — THE ctx CONNECTOR IN claude.ai, ITS SIX TOOLS EACH SET TO REQUIRE APPROVAL.">
...
<BpFigure caption="FIG. 6 — THE OAuth 2.1 HANDSHAKE. THE ONLY HUMAN STEP IS PASTING A TOKEN IN MY OWN BROWSER; THE AGENT NEVER SEES IT.">
...
<BpSection id="s8" num="08" label="Adversarial review" sheet="SHEET 8 OF 9" title="Three rounds with a hostile reviewer" />
...
<BpSection id="s9end" num="09" label="Cost & worth" sheet="SHEET 9 OF 9" title="What it cost and what it's worth" />
...
<BpFigure caption="FIG. 7 — A COLD CLAUDE SESSION, GIVEN ONLY THE URL, BRIEFS ME FROM THE VAULT AND TICKETS.">
