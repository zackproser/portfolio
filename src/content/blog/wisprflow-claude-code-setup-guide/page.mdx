...
- **<AffiliateLink product="wisprflow" campaign={campaign}>WisprFlow</AffiliateLink>** turning your speech into polished text at 179+ WPM in any app
...
|---|---|---|
| **Voice Input** | <AffiliateLink product="wisprflow" campaign={campaign}>WisprFlow</AffiliateLink> | Syntax-smart voice dictation — works in terminals, IDEs, browsers, everywhere |
...
<Image src="https://zackproser.b-cdn.net/images/wisprflow.webp" alt="WisprFlow voice dictation — 4x faster than typing" width={800} height={600} />

### Installation

1. Download <AffiliateLink product="wisprflow" campaign={campaign}>WisprFlow</AffiliateLink>
...
<Image src="https://zackproser.b-cdn.net/images/wisprflow-interface.webp" alt="WisprFlow recording interface showing real-time transcription" width={800} height={600} />
