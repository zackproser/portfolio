...
For capturing voice while working at my desk, [WisprFlow](https://ref.wisprflow.ai/zack-proser) lets me speak at 179 WPM into any app on my Mac. For capturing meeting conversations (both virtual and in-person), [Granola](https://go.granola.ai/zack-proser) runs in the background and creates AI-enhanced notes without a bot joining my calls.
