...
import readyToGo from '@/images/ready-to-go.webp'
import walkingHero from '@/images/walking-talking-ai.webp'
import river from '@/images/river-walking-ai.webp'
import trail from '@/images/trail-walking-ai.webp'
import bleachers from '@/images/bleachers-walking-ai.webp'
import parkingLot from '@/images/parking-lot-walking-ai.webp'
import leafBlowing from '@/images/leaf-blowing-walking-ai.webp'
import busy from '@/images/busy.webp'
import mnistApp from '@/images/mnist-mind-mapper-splash.webp'
...
export const metadata = createMetadata({
    ...
    date: "2025-04-12",
    title: "Walking and talking with AI in the woods",
    description: "This is the highest leverage use of AI I have found so far...",
    image: walkingHero,
});
...
<figcaption>
    My latest pasttime is walking and talking with AI in the woods
</figcaption>
...
I start these walks with my mind occupied by various competiting priorities and interests.
...
I’ll close the screen of my Pixel phone, and carry on chatting hands-free. The biggest issue I have now is 
...
As I continue my trek, I'll sort out the order of priorities to tackle, and I'll continue talking through plans to improve or streamline a system or ask for critical feedback on a campagin or conversion funnel I'm building.
...
The feedback loop of conversation with a model that has essentially read eveyrthing can elevate an ordinary walk into an inspiring learning session. 

By the time I return to the parking lot, I often already have solutions I’ve been chasing for days.

I suspect that this habit will spread as more and more folks find it helpful, and as a result I expect we'll see additonal products and services tailored to the untethered crowd: those
