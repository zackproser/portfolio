...
Then I started using <AffiliateLink product="granola">Granola</AffiliateLink>. It captures meeting content automatically — no bot joining the call, no obvious recording indicator, just quiet background capture. After the meeting, I get structured notes with action items extracted.
