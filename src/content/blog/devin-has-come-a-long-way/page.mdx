...
<Image src="https://app.devin.ai/attachments/477c1c16-15a2-4438-82da-06b97d79c4ef/image.png" alt="Devin's response in Slack showing a stack-ranked table of top blog posts by composite score including views, users, and average engagement time" width={1024} height={900} />
...
<Image src="https://app.devin.ai/attachments/116506cc-5099-4010-8967-568a0c30c669/image.png" alt="Devin session showing a PR that replaces sensor animation with onomatopoeic beeping, handling three.js component changes and audio autoplay logic" width={1024} height={768} />
