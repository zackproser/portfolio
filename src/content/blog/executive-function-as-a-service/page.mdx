...
<InlineCTA heading="More writing like this →" />
...
This is body doubling — the ADHD strategy of working alongside someone else to borrow their activation energy. AI agents are the most patient body doubles that have ever existed. They don't judge the gap between "knowing" and "doing." They just start.
...
<InlineCTA heading="Get the next ND-engineer playbook post →" />
...
<InlineCTA heading="Send me the next essay when it drops →" />
