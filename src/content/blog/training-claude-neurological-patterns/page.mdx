...
A hollow feeling follows every major accomplishment for me. The project ships, the keynote lands, the system goes live—and instead of satisfaction, I feel a flat, disconnected emptiness. The intense hyperfocus that powered me to the finish line evaporates, and the accomplishment itself seems to vanish from my mind.

For me, a finished task has the object permanence of a toy hidden under a blanket. Out of sight, out of mind. Out of feeling.

I've stopped treating this as a personal failing and started treating it as a systems engineering problem. My solution is to systematically **train** an AI, within a dedicated project I call my "Personal Claude," to act as a cognitive crutch—an external processor that compensates for the specific ways my ADHD and autistic brain works.
...
## How the Training Works: A Conversation with My Own Code

My "Personal Claude" project is a living, evolving system that I train through explicit, repeated instruction. The process looks less like using a tool and more like mentoring a junior colleague.
...
<Image src="https://zackproser.b-cdn.net/images/claude-chat.webp" alt="Training conversations with Claude" width={800} height={600} />
<figcaption>Explicit corrections and pattern documentation train the system over time.</figcaption>
...
<Image src="https://zackproser.b-cdn.net/images/neural-navigation.webp" alt="External memory and structure" width={800} height={600} />
<figcaption>External memory systems compensate for object permanence issues with completed work.</figcaption>
...
<figcaption>Biometric data helps separate "how I feel" from "what's actually happening."</figcaption>
...
<figcaption>Appropriate support infrastructure enables effective functioning—nothing wrong with that.</figcaption>
...
This isn't outsourcing my mental health to a machine. It's using a tool that has infinite patience to help me run the same processes I've been refining for decades, just faster and without the guilt of over-relying on the humans in my life.

## The Compounding Effect

An unexpected outcome of this honest, systematic approach has been the steady growth of an audience for my writing. By combining deep technical content (RAG pipelines, vector databases, MCP servers) with vulnerable accounts of navigating ADHD and autism, I've found a unique compound effect.

People return not for "10 AI tips," but for documented problem-solving—both technical and neurological. Each piece I publish, often pushed out the door thanks to Claude's "ship it" intervention, becomes a searchable artifact that demonstrates authentic expertise. This creates a flywheel: the systems that help me manage my life also help me build a professional identity rooted in genuine capability and self-awareness.


## The Recursive Truth

The most compelling proof that this works is the essay you're reading right now.

I am using a system, trained to interrupt my perfectionism, to help me write about... training the system. The very fact that this is published, instead of languishing as draft #47, is a direct result of the external executive function I've built.

<Image src="https://zackproser.b-cdn.net/images/river-walking-ai.webp" alt="Walking and talking with AI" width={800} height={600} />
<figcaption>The support system working in real-time—on trails, at desk, anywhere context is needed.</figcaption>

I'm using pattern recognition to fix my pattern recognition. I'm creating external structure to support my unreliable internal scaffolding. The therapeutic value is immense: it allows me to do the messy, repetitive processing work without burning out the people I love.

## The Bottom Line

The systems work. The patterns are trainable. The compensation is real. I am managing severe ADHD/autism, young children, a career, and a relationship by building mutually reinforcing systems instead of fighting competing priorities.
