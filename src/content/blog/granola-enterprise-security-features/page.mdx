...
export const campaign = "granola-enterprise-security-features"
...
<AffiliateLink product="granola" campaign={campaign}>Granola's enterprise security features</AffiliateLink> provide the comprehensive protection that large organizations require. From SOC 2 compliance to HIPAA business associate agreements, the platform meets the highest security standards while delivering powerful AI meeting capabilities.
