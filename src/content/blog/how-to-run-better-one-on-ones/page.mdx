...
export const campaign = 'how-to-run-better-one-on-ones'
...
1. **<AffiliateLink product="granola" campaign={campaign}>Granola</AffiliateLink> runs in the background** — no bot joins the call, no recording notification, just quiet capture
