...
const img = (name) => `https://zackproser.b-cdn.net/images/${name}`
const generativeAIBootcamp = img('generative-ai-bootcamp.webp')
const zacharyProser = img('zachary-proser.webp')
const a16z2 = img('a16z-2.webp')
const aiImageGeneration = img('ai-image-generation.webp')
const genAiExampleImageGeneration = img('gen-ai-image-generation-example.webp')
const vercelV0Dev = img('vercel-v0-dev.webp')
const pulumiAI = img('pulumi-ai-example.webp')
const genAIHow = img('generative-ai-how.webp')
const genAIMoment = img('generative-ai-moment.webp')
const tmuxFlow = img('tmux-flow.gif')
const codingAutocomplete = img('coding-autocomplete.webp')
const learningGenerations = img('learning-generations.webp')
const vscodeHomepage = img('vscode-homepage.webp')
const githubCopilotDemo = img('github-copilot-example.webp')
