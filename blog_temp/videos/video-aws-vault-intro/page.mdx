...
import awsVault from '@/images/aws-vault.webp'

import { createMetadata } from '@/utils/createMetadata'

import rawMetadata from './metadata.json' assert { type: 'json' };
export const metadata = createMetadata(rawMetadata); and is a much more efficient way to access multiple AWS accounts.",
  image: awsVault
})
...
<iframe 
  class="youtube-video"
  src="https://www.youtube.com/embed/G9eIAb0B-zs" 
