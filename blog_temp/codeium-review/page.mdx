...
import codeiumCompletions from '@/images/codeium-completions-breakdown.webp'
...
export const metadata = createMetadata(rawMetadata);, I gave the alternative, Codeium a shot.",
