...
// Directories
const sourceDir = path.join(process.cwd(), 'src/app/videos');
const targetDir = path.join(process.cwd(), 'src/content/videos');
...
console.log(`Found ${slugDirs.length} video directories to move`);
...
console.log('2. Once verified, you can safely delete the original directories from src/app/videos/');
